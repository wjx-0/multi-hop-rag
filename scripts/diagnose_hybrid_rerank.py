# 中文说明：批量诊断 Hybrid top-k 经 DashScope reranker 重排后的证据召回。
"""Run hybrid retrieval plus DashScope rerank diagnostics without answer generation."""
...
def main() -> None:
    ...
    if not reranker.api_key:
        raise ValueError("DASHSCOPE_API_KEY is empty. Fill it in .env before running rerank diagnostic.")
