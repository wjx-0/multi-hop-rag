...
- 支持查询分解 query mode 消融。（已实现 `original_plus_generated` / `generated_or_original`，用于验证原问题是否压制分解 query）
...
LLM query decomposition + decomposed Hybrid retrieval diagnostic
Query decomposition query mode ablation
